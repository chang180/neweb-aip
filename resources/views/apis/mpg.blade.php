...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets/tailwind.min.css')}}"/> <!--Replace with your tailwind.css once created-->
    <link href="{{asset('assets/emoji.css')}}" rel="stylesheet"> <!--Totally optional :) -->
